        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row">
              ...
              @endif
               <!-- form start -->
              <form name="categoryForm" id="categoryForm" @if(empty($category['id'])) action="{{ url('admin/add-edit-cms-page') }}" @else action="{{ url('admin/add-edit-cms-page/'.$category['id']) }}" @endif method="post">@csrf
                <div class="card-body">
